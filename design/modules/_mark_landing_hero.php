...
if ($img) : ?>
  <div class="hero">
    ...
    <ul class="button-group block-spacing">
      <?php while (have_rows('cmark_header_buttons', 'options')) : the_row(); ?>
        <?php
    ...
    <?php echo wp_get_attachment_image($img, 'hero-desktop', false); ?>
      ...
      <?php if( $post_id_1 ): ?>
        <?php 
          $term = get_primary_term('mark_categories', $post_id_1);
          if($term) {
...
<div class = "block-bottom">
  ...
  <?php if( $post_id_2 ): ?>
    <div class="news__secondary__item">
      ...
      <div class="feed__content">
        <?php 
        $term = get_primary_term('mark_categories', $post_id_2);
        if($term) {
  ...
  <?php if( $post_id_3 ): ?>
    <div class="news__secondary__item">
      ...
      <div class="feed__content">
        <?php 
        $term = get_primary_term('mark_categories', $post_id_3);
        if($term) {
          echo "<div class=\"feed__tag\">";
          echo $term->name ;
          echo "</div>";
